...
<h1 style="text-align: center; color: white;"><?php echo $user_data['username'] ?>'s&nbsp;Photos</h1>
	...
	<?php
		...
		if(is_array($images)){
			...
			foreach ($images as $image_row) {
				...
				echo "<img src='" . $image_class->get_thumb_post($image_row['image']) . "' style='width:150px;margin:10px; border: 1px solid red;' />";
				echo "</a>";
			}
